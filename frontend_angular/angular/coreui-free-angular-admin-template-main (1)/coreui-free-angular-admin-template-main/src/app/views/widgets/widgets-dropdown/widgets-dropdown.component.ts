...
import { BotService, Budget, Fans, GoalRatio } from 'D:/matlab/AN3 sem2/II/Lab1/frontend_angular/angular/coreui-free-angular-admin-template-main (1)/coreui-free-angular-admin-template-main/src/app/services/bot.service';
...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  datasets = [
    [{
      ...
      data: this.botService.getBudget()
    }], [{
      label: 'Points/Game',
  ...
  ngAfterContentInit(): void {
    ...
    // this.botService.getFans()
  // this.botService.getBudget()
  // this.botService.getGoals(),
  setData() {
